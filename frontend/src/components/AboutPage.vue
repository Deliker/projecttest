<template>
    <div class="home-page">
      <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">
                {{ $t('about.titleStart') }}
                <span class="accent">{{ $t('about.titleAccent') }}</span>
            </h1>
      ...
      <section class="features-section">
        <div class="section-header">
          <h2 class="section-title">{{ $t('about.OurTeam') }}</h2>
        ...
        <div class="features-grid">
          ...
          <div class="feature-card">
            <div class="feature-icon">
              <img src="@/assets/team1.png" alt="Team Member 1" width="64" height="64" />
            </div>
            <h3>{{ $t('about.team1') }}</h3>
            <p>{{ $t('about.team.text1') }}</p>
          </div>
  
          <div class="feature-card">
            <div class="feature-icon">
                <img src="@/assets/team2.png" alt="Team Member 2" width="64" height="64" />
            </div>
            <h3>{{ $t('about.team2') }}</h3>
            <p>{{ $t('about.team.text2') }}</p>
          </div>
  
          <div class="feature-card">
            <div class="feature-icon">
                <img src="@/assets/team3.png" alt="Team Member 3" width="64" height="64" />
            </div>
            <h3>{{ $t('about.team3') }}</h3>
            <p>{{ $t('about.team.text3') }}</p>
          </div>
        </div>
      </section>
  ...
  .hero-stats {
    ...
    background: var(--color-card-bg);
    border-radius: 12px;
    animation: fadeSlideUp var(--transition-medium) ease-out 0.6s backwards;
    border: 1px solid var(--color-border);
  }
